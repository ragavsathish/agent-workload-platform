...
| `packages/mermaid-to-excalidraw` | `mermaid-to-excalidraw` | `master` | `e7ce159` — `feat: add C4 Gondolin layout worker` |
| `pipelines/c4-excalidraw` | extracted from the `excalidraw-mcp` snapshot | `main` | `d7c1664` |
