...
for world in c4-compiler c4-compiler-core c4-layout-component excalidraw-policy-component; do
...
echo "Validated WIT worlds: c4-compiler, c4-compiler-core, c4-layout-component, excalidraw-policy-component"
